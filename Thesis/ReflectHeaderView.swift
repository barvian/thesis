...
class ReflectHeaderView: UIView {
    ...
    override func updateConstraints() {
        if !didSetupConstraints {
            ...
            addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-(vMargin)-[headlineLabel]-(4)-[subheaderLabel]-(vMargin)-[addButton(70)][lineView(64)]|", options: nil, metrics: metrics, views: views))
